...
if ($foto !="") {
	...
	if (in_array($extensi, $ekstensi_diperbolehkan) == true) { 
		...
		$query = "INSERT INTO kamar (no_kamar,tipe_kamar,foto) VALUES ('$no_kamar', '$tipe_kamar', '$nama_gambar_baru')";
	...
	$query = "INSERT INTO kamar (no_kamar,nm_kamar,foto) VALUES ('$no_kamar', '$tipe_kamar', null)";
	$result = mysqli_query($koneksi, $query);
	if (!$result) {
		die("Query gagal dijalankan : ".mysqli_errno($koneksi)."-".mysqli_error($koneksi));
	} else {
